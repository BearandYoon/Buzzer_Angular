 ...
 */
function rickshaw($compile, $window, $rootScope) {
  ...
  return {
    ...
    link: function (scope, element) {
      ...
      function update() {
        if (!graph) {
          ...
          if (scope.features && scope.features.xAxis) {
            ...
            if (scope.features.xAxis.type === 'X') {
      ...
      $rootScope.$on('recalculateSize', function () {
        update();
      })
...
angular.module('bzrdashApp').directive('rickshaw', rickshaw);
